(() => {
  ...
  // src/appendElements/inject.ts
  var import_webextension_polyfill_ts = __toESM(require_lib());
  var injectedScript = document.createElement("script");
  injectedScript.src = import_webextension_polyfill_ts.browser.runtime.getURL("index.js");
